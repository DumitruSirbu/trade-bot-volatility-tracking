...
describe('FillSimulatorCore', () => {
    describe('applyFill', () => {
        it('should simulate a simple fill with tier-1 slippage', () => {
            ...
            const result = applyFill(snapshot, intent, CoinTierEnum.TIER_1, { slippage_tier1_pct: 0.15 }, seed, [], 1000, 5000, 1000);
        ...
        it('should apply correct fee rate for maker policy', () => {
            ...
            const result = applyFill(snapshot, intent, CoinTierEnum.TIER_1, {}, seed, [], 1000, 5000, 1000);
        ...
        it('should apply tier-2 slippage', () => {
            ...
            const result = applyFill(snapshot, intent, CoinTierEnum.TIER_2, { slippage_tier2_pct: 0.5 }, seed, [], 1000, 5000, 1000);
        ...
        it('should apply tier-3 slippage', () => {
            ...
            const result = applyFill(snapshot, intent, CoinTierEnum.TIER_3, { slippage_tier3_pct: 1.0 }, seed, [], 1000, 5000, 1000);
        ...
        it('should detect missed fill when limit not touched', () => {
            ...
            const result = applyFill(snapshot, intent, CoinTierEnum.TIER_1, {}, seed, ticks, 1000, 5000, 1000);
    ...
    describe('applyIntraBarStop', () => {
        ...
        it('should return null when neither SL nor TP hit', () => {
            ...
            const ticks: ITickAggregateSnapshot[] = [{ high: '100.50', low: '99.50', close: '100.00', ts: new Date(2000) }];

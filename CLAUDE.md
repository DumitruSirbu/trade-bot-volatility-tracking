...
**Pre-M7 deferred:** M2 partition-rollover task for fresh Postgres volume (narrow scope, test-harness or service pre-create partitions for current/upcoming date window).
**Next:** **M7 — Backtesting & performance** (`docs/plans/M7-backtesting.md`).

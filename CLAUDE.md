...
**Current status:** M31 done (zombie position lifecycle fix), data repair SQL ready, deploy pending — full milestone history, test counts, and go-live gates in `docs/milestone-log.md`.

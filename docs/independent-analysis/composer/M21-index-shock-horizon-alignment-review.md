...
A parallel review exists at `docs/independent-analysis/gbt/M21-index-shock-horizon-alignment-review.md`. Conclusions align on: approve direction, ETH raise is clearly good, BTC 1.5% is reasonable but thinly calibrated, stale halt + test sweep amendments, §6c supersession. This Composer review adds emphasis on **BTC as enabling a new leg**, **rolling-window measurement semantics**, and **orphan `tieringConsts` drift**.

...
> derived from the architect analysis [main-architector-paper-soak-fill-and-gate-analysis.md](../wip/main-architector-paper-soak-fill-and-gate-analysis.md)
...
Independent reviews (`docs/independent-analysis/{composer,gbt,gemini}/M24-paper-open-fill-wiring-review.md`)
...
- Architect analysis (P0): [main-architector-paper-soak-fill-and-gate-analysis.md](../wip/main-architector-paper-soak-fill-and-gate-analysis.md) §2.3, §5 P0, §6
- Independent reviews (2026-06-08, source of amendments A1–A3 / M1–M3):
  [composer](../independent-analysis/composer/M24-paper-open-fill-wiring-review.md),
  [gbt](../independent-analysis/gbt/M24-paper-open-fill-wiring-review.md),
  [gemini](../independent-analysis/gemini/M24-paper-open-fill-wiring-review.md)

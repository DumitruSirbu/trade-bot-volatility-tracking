...
Independent reviews (`docs/archive/independent-analysis/{composer,gbt,gemini}/M26-*`) **approve the direction**
...
- Architect analysis (P4): [main-architector-paper-soak-fill-and-gate-analysis.md](../../wip/done/main-architector-paper-soak-fill-and-gate-analysis.md) §2.3, §5 P4
- Independent reviews (2026-06-08, source of amendments A1–A9):
  [composer](../../archive/independent-analysis/composer/M26-shadow-counterfactual-fill-wiring-review.md),
  [gbt](../../archive/independent-analysis/gbt/M26-shadow-counterfactual-fill-wiring.md),
  [gemini](../../archive/independent-analysis/gemini/M26-shadow-counterfactual-fill-wiring.md)
...
- M7 backtest tick sourcing (the pattern M26 mirrors): [docs/plans/archive/M7-backtesting.md](M7-backtesting.md)

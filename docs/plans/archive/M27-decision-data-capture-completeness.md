...
Independent reviews (`docs/archive/independent-analysis/{composer,gbt,gemini}/M27-*`) **approve the direction**
...
- Architect analysis (P5): [main-architector-paper-soak-fill-and-gate-analysis.md](../../wip/done/main-architector-paper-soak-fill-and-gate-analysis.md) §4, §5 P5, §6 (DB safety)
- Independent reviews (2026-06-08, source of amendments A0–A9):
  [composer](../../archive/independent-analysis/composer/M27-decision-data-capture-completeness-review.md),
  [gbt](../../archive/independent-analysis/gbt/M27-decision-data-capture-completeness.md),
  [gemini](../../archive/independent-analysis/gemini/M27-decision-data-capture-completeness.md)
...
- Slippage-telemetry follow-on (measured vs tier-constant): [docs/plans/archive/M22-depth-floor-recalibration.md](M22-depth-floor-recalibration.md) §Verification
- Produces the rows M27 annotates: M24 (paper fills), M26 (shadow fills); concurrency from M25
- Test-DB isolation for migration validation: [docs/plans/archive/M16-test-db-isolation.md](M16-test-db-isolation.md)

...
| M7 | MAE/MFE seed-timing gap — accumulator seeded async post-`POSITION_OPENED_EVENT`; first-second excursion (peak risk window for this strategy) may be lost | `PositionInstrumentor.ts` | M35 |

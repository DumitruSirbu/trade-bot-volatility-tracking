...
**Plan reviewed:** `docs/plans/archive/M26-shadow-counterfactual-fill-wiring.md`  
...
- Plan: `docs/plans/archive/M26-shadow-counterfactual-fill-wiring.md`
- WIP analysis: `docs/wip/done/paper-soak-zero-trades-and-shadow-fill-gap.md` (Tier C — minimal fix superseded by M26)
- Related: `docs/archive/independent-analysis/composer/M24-paper-open-fill-wiring-review.md` (same miss-detector root cause on live path)
